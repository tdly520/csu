DATAS SEGMENT
    ; 输入buf1的数据
    buf1 DW 2 DUP(?)  ; 2个元素初始化为零

    ; 输入buf2的数据
    buf2 DW 4 DUP(?)  ; 4个元素初始化为零

    ; 用4个零初始化buf3
    buf3 DW 4 DUP(0)

    ; 用于提示和消息的字符串
    string_input_buf1 DB 'Enter 2 numbers for buf1 (0-65535): $'
    string_input_buf2 DB 'Enter 4 numbers for buf2 (0-65535): $'
